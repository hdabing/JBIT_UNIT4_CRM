...
<body>
<div class="page_title">客户服务管理 &gt; 服务查询</div>
...
<s:iterator value="pagebean.list">
	<tr>
		...
		<td class="list_data_text"><s:property value="servicestate.name" /></td>
		<td class="list_data_op">		
			<img onclick='location.href="archServicelist?id=<s:property value="id" />";' title="查看" src="images/bt_detail.gif" class="op_button" /></td>
	</tr>
</s:iterator>
	<tr>
