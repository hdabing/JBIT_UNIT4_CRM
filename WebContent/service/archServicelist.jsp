...
<table class="query_form_table">
	...
	<tr>
		...
		<th>状态</th>
		<td><%=servicelist.getServicestate().getName() %></td>
	</tr>	
	<tr>
		<th>服务请求</th>
...
<table class="query_form_table" id="table1">
	<tr>
		<th>服务处理</th>
		<td colspan="3"><%if(servicelist.getOperatorcontent()!=null){out.print(servicelist.getOperatorcontent());} %></td>
	</tr>
	<tr>
		<th>处理人</th>
...
<table class="query_form_table" id="table2">
	<tr>
		<th>处理结果</th>
		<td><%if(servicelist.getResultcontent()!=null){out.print(servicelist.getResultcontent());} %></td>
		<th>满意度</th>
		<td>
		<%for(int i=0;i<servicelist.getAgreelevel();i++){ %>
