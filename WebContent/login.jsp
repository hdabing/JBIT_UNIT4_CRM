...
<table width="100%" BORDER=0>
        <tr> 
          <th><%=name %></th>
          <td><input type="text" id="username" name="user.username" size="10" maxlength="20" /></td>
        </tr>
        <tr> 
          <th><%=pwd %></th>
          <td><input type="password" id="password" name="user.password" size="10" maxlength="20" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td><img onclick="javascript:checkAll(frmLogin);" src="images/login/login_button.jpg" width="73" height="25"></td>
        </tr>
      </table>
</form>
    </TD>
	...
	<TR>
		<TD COLSPAN=2>
		<div style="background:url(images/login/login_14.jpg) no-repeat left top; width=201px;height=27px ">
		<%if(request.getAttribute("ERROR")!=null){ %>
			<span class="red_star"><%=request.getAttribute("ERROR") %></span>
		<%} %>
		</div>
			<!--  <IMG SRC="images/login/login_14.jpg" WIDTH=201 HEIGHT=27 ALT="">-->
		</TD>
		<TD>
